...
const initializePassport = () => {
    ...
    const cookieExtractor = (req) => {
      ...
      if (req.headers.authorization && req.headers.authorization.startsWith('Bearer')) {
        // Si hay un encabezado de autorización y comienza con "Bearer"
        token = req.headers.authorization.split(' ')[1]; // Extraer el token sin el prefijo
      }
  ...
  console.log("prueba de jwt");  // Esto se ejecutará una vez al iniciar la aplicación
